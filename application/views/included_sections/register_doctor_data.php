                          ...
                          <div class="col-sm-9">
                            <div class="tab-content">
                                      ...
                                      <div class="form-group col-xs-6"> 
                                        ...
                                        <input type="text" id="d_name" value="<?php echo set_value('d_name');?>" class="form-control" name="d_name" placeholder="ادخل اسم الطبيب ثلاثيا مع اللقب" title="ادخل اسم الطبيب ثلاثيا مع اللقب" autofocus required>
                                        <span class="error-msg" id="d_name_error_msg"></span>
                                      </div>
                                      <div class="form-group col-xs-6"> 
                                        <label>البريد الالكتروني*</label>
                                        <input type="email" id="d_email" value="<?php echo set_value('d_email');?>" class="form-control" name="d_email" placeholder="you@email.com" title="ادخل عنوان البريد الاكتروني" autofocus required>
                                      ...
                                      <div class="form-row">
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                          <label>الجنسية*</label>
                                          <select name="nationality" class="form-control" style="direction:ltr;" title="الجنسية" title="اختر الجنسية"autofocus required>
                                      ...
                                      <div class="form-group col-xs-6"> 
                                        <input type="text" id="d_street_address" value="<?php echo set_value('d_street_address');?>" class="form-control" name='d_street_address' placeholder="ادخل الشارع"  title="ادخل الشارع" autofocus ><!-- pattern="^[A-Za-z0-9_ء-ي'\s]{5,200}+$" -->
                                        <span class="error-msg" id="d_street_error_msg"></span>
                                      </div>
                                      <div class="form-group col-xs-6"> 
                                          <label>عنوان صفحة الفيسبوك</label>
                                          <input type="url" id="d_facebook_link" value="<?php echo set_value('d_facebook_link');?>" class="form-control" name='d_facebook_link' placeholder="ادخل رابط صفحة الفيسبوك" title="ادخل رابط صفحة الفيسبوك" autofocus>
                                          <span class="error-msg" id="d_facebook_error_msg"></span>
                                      </div>
                                      <div class="form-group col-xs-6"> 
                                          <label>عنوان صفحة تويتر</label>
                                          <input type="url" id="d_twitter_link" value="<?php echo set_value('d_twitter_link');?>" class="form-control" name='d_twitter_link' placeholder="ادخل رابط صفحة تويتر" title="ادخل رابط صفحة تويتر" autofocus>
                                      ...
                                      <div class="form-group col-xs-6"> 
                                          ...
                                          <input type="password" id="d_password" value="<?php echo set_value('d_password');?>" class="form-control" name="d_password" placeholder="ادخل كلمة المرور" title="ادخل كلمة المرور">
                                          <span class="" id="d_password_error_msg"></span>
                                      </div>
                                      <div class="form-group col-xs-6">
                                          <label>تأكيد كلمة المرور*</label>
                                          <input type="password" id="d_password_c" value="<?php echo set_value('d_password_c');?>" class="form-control" name="d_password_c" placeholder="ادخل تأكيد كلمة المرور" title="ادخل تأكيد كلمة المرور">

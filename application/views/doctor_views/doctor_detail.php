				...
				<div class="wrapper row">
					<div class="col-md-4">
						<div class="tab-content" style="margin-bottom:1rem;">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url();?>assets/images/doctors/personal/doctor.png?>"/></div>
						<div style="background-color:#13bfb1;">
							<div class="clinic-icon" style="padding: 10px 10px 0 10px;">
			                     ...
			                     <span class="text-muted doctor-connection" >96777777777+</span>
			                </div>
			                <div class="clinic-icon" style="padding: 0 10px 10px 10px;">
			                     <i class="fa fa-envelope fa-md doctor-i-connection" ></i> 
			                     <span class="text-muted doctor-connection" >walid@wsam.ae</span>
			                </div>
                            </div>
						</div>
						<h6>اضف تقييمك</h6>
					...
					<div class="col-md-8">
						<h4 class="product-title">د.وليد محمد ناصر</h4>
						<a href="#">
